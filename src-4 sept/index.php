		...
		<div class="row">
			<div class="medium-8 column text-justify">
				...
				<section>
					...
					<p>Your thoughtful completion of the lineage survey regarding your dance background and major influences will be invaluable to the creation of this resource. The completion of the Choreographic Lineage survey is voluntary and can be accessed by clicking <a href="sections/contribute.html">here.</a></p>
				</section>
				<section>
			...
			<aside class="medium-4 column">
				...
				<div class="callout primary">
					...
					<small>
							...
							Jay Narendra Shah, Graduate Student Research Assistant<br>
					</small>
				</div>
			</aside>
		</div>

...
<body>
	...
	<form id="biography" class="biography">
		...
		<div class="row">
			...
			2. <strong>STUDIED WITH</strong> - Teachers with whom you hava danced<br>
			...
			If the artist for whom you are filling out this form is realted to a lineal artist in more than one way( ex. She both danced for and studied with this person), click "add another relationship with same lineal artist", notating each type of relationship as a separate entry.<br><br>
			<strong>Please click the button "Next Page" to contribute artist's lineage.</strong>
			</p>

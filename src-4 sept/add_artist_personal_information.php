			...
			<div class="row">
				<fieldset class="large-2 columns">
					<label><legend><strong>Your Date of Birth</strong></legend>
						<input type="text" class="date_of_birth" id="date_of_birth" placeholder="yyyy-mm-dd" name="date_of_birth" required
				...
				<div class="row">
					<div class="medium-4 columns shrink">
						<label for="city" class="text-left middle"><legend><strong>City of Residence</strong></legend>
							<input type="text" id="city" placeholder="City" name= "city_residence" required
			...
			<div class="medium-12 column">
						...
						<div id="education_entries" class="row education_entries">
							<div class="small-3 column">
								<label for="university_name">University Name
									...
									placeholder="Name of the school/University" required
							...
							<div class="small-3 column">
								<label for="major">Major
									<input type="text" class="major" id="major" name="major[]" placeholder="Name of the Major" required
				...
				<?php else: ?>
					<div id="education_entries" class="row education_entries">
						<div class="small-3 column">
							<label for="university_name">University Name
								<input type="text" class="university_name" id="university_name" name="university[]" placeholder="Name of the school/University" required>
							</label>
						</div>
						<div class="small-3 column">
							<label for="major">Major
		...
		<div class="row">
					...
					<div id="other_education_entries" class="row other_education_entries">
						...
						<div class="small-4 column">
							<label for="other_degree">Degree, Certificate or Training
								...
								placeholder="Name of the Degree, Certificate or Training" required
			...
			<?php else: ?>
				<div id="other_education_entries" class="row other_education_entries">
					<div class="small-5 column">
						<label for="institution_name">Institution Name
							<input type="text" class="institution_name" id="institution_name" name="institution_name[]" placeholder="Name of the Institution" required>
						</label>
					</div>
					<div class="small-4 column">
						<label for="other_degree">Degree, Certificate or Training
							<input type="text" class="other_degree" id="other_degree" name="other_degree[]" placeholder="Name of the Degree, Certificate or Training" required>
						</label>
					</div>
					<div class="small-3 column">
						<label for="delete_other_education"><span><br></span>

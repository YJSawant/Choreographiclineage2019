...
if(isset($_SESSION["artist_profile_id"])){
  ...
  $institutions = array();
  $other_degrees = array();
  while($row = mysqli_fetch_assoc($artist_education)){
  ...
  $influenced_sd = array();
  $influenced_ed = array();
  $influenced_years = array();
  $influenced_months = array();
  ...
  while($row = mysqli_fetch_assoc($artist_relations)){
    ...
    if($row["artist_relation"] == "Studied With"){
      ...
      $influenced_sd[$relation_artist_counter] = ($row["start_date"] == "0000-00-00"?"":$row["start_date"]);
      $influenced_ed[$relation_artist_counter] = ($row["end_date"] == "0000-00-00"?"":$row["end_date"]);
      $influenced_years[$relation_artist_counter] = $row["duration_years"];
      $influenced_months[$relation_artist_counter] = $row["duration_months"];
    }
  }
  ...
  $_SESSION["influenced_start_date"] = $influenced_sd;
  $_SESSION["influenced_end_date"] = $influenced_ed;
  $_SESSION["influenced_duration_years"] = $influenced_years;
  $_SESSION["influenced_duration_months"] = $influenced_months;
  $_SESSION["form_1"] = "Completed";
  //echo $relation_artist_counter;
  //print_r($_SESSION["lineage_artist_email_address"]);

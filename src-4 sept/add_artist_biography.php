...
<body>
	...
	<div class="row">
		...
		<div class=" large-4 medium-4 small-4 columns"><!-- INSERT THE INPUT FIELDS HERE -->
			<form id="upload_biography" action="" method="post" enctype="multipart/form-data">
				<div class="row">
					<h5><em>Upload your biography either as a pdf/word document<em></h5>
	...
	<div class="row">
		...
		<h5><em>Please provide your headshot or dance photo for your profile.(Files can be jpg, png, jpeg)</em></h5>
	</div>

											  ...
											  <div class="medium-3 columns">
											    <ul class="vertical tabs" data-tabs id="relation-tabs<?php echo '-'.$key ?>">
											      <li class="tabs-title is-active"><a href="#panel1v<?php echo '-'.$key ?>" aria-selected="true" aria-controls="panel1v<?php echo '-'.$key ?>">
															<input class="relationship relation_studied_cb" name="relationship_studied[]" id="relationship_studied<?php echo '-'.$key ?>" type="checkbox" value="studied_with_section"
															<?php
											      ...
											      <li class="tabs-title"><a href="#panel2v<?php echo '-'.$key ?>" aria-controls="panel2v<?php echo '-'.$key ?>">
															<input class="relationship relation_danced_cb" name="relationship_danced[]" id="relationship_danced<?php echo '-'.$key ?>" type="checkbox" value="danced_for_section"
															<?php
											      ...
											      <li class="tabs-title"><a href="#panel3v<?php echo '-'.$key ?>" aria-controls="panel3v<?php echo '-'.$key ?>">
															<input class="relationship relation_collaborated_cb" name="relationship_collaborated[]" id="relationship_collaborated<?php echo '-'.$key ?>" type="checkbox" value="collaborated_with_section"
															<?php
											      ...
											      <li class="tabs-title"><a href="#panel4v<?php echo '-'.$key ?>" aria-controls="panel4v<?php echo '-'.$key ?>">
															<input class="relationship relation_influenced_cb" name="relationship_influenced[]" id="relationship_influenced<?php echo '-'.$key ?>" type="checkbox" value="influenced_by_section"
															<?php
																if(isset($_SESSION['influenced_duration_months'])){
																	echo (($_SESSION['influenced_duration_months'][$key] != '' || $_SESSION['influenced_duration_years'][$key] != '') &&
																	($_SESSION['influenced_duration_months'][$key] != 0 || $_SESSION['influenced_duration_years'][$key] != 0) ?'checked':'');
																}
															?>
															/>
																...
																<div class="row duration_selection">
																	...
																	<div class="large-5 columns">
																		...
																		<div class="row">
																			<div class="medium-6 column">
																				<label>Start Date
																					<input type="text" class="start_date" id="influenced_start_date<?php echo '-'.$key ?>" placeholder="yyyy-mm-dd" name="influenced_start_date[]"
																						value="<?php echo (isset($_SESSION['influenced_start_date'])?$_SESSION['influenced_start_date'][$key]:'')?>"
																					/>
																				</label>
																			</div>
																		</div>
																		<div class="row">
																			<div class="medium-6 column">
																				<label>End Date
																					<input type="text" class="end_date" id="influenced_end_date<?php echo '-'.$key ?>" placeholder="yyyy-mm-dd" name="influenced_end_date[]"
																						value="<?php echo (isset($_SESSION['influenced_end_date'])?$_SESSION['influenced_end_date'][$key]:'')?>"
																					/>
																				</label>
																			</div>
																		</div>
																	...
																	<div class="large-5 columns">
																		...
																		<div class="row">
																			<div class="small-6 column">
																				<label for="duration_years">Years<small> Required</small>
																					<input  autocomplete="off" type="text" class="duration_years" id="influenced_duration_years<?php echo '-'.$key ?>" name="influenced_duration_years[]" placeholder="Years"
																						value="<?php echo (isset($_SESSION['influenced_duration_years'])?$_SESSION['influenced_duration_years'][$key]:'')?>"
																						<?php
																							if(isset($_SESSION['influenced_start_date'])){
																								echo (($_SESSION['influenced_start_date'][$key] != '' && $_SESSION['influenced_end_date'][$key] != '') ?'readonly':'');
																							}
																						?>
																					/>
																				</label>
																		...
																		<div class="row">
																			<div class="small-6 column">
																				<label for="duration_months">Months<small> Required</small>
																					<input  autocomplete="off" type="text" class="duration_months" id="influenced_duration_months<?php echo '-'.$key ?>" name="influenced_duration_months[]" placeholder="Months"
																						value="<?php echo (isset($_SESSION['influenced_duration_months'])?$_SESSION['influenced_duration_months'][$key]:'')?>"
																						<?php
																							if(isset($_SESSION['influenced_start_date'])){
																								echo (($_SESSION['influenced_start_date'][$key] != '' && $_SESSION['influenced_end_date'][$key] != '') ?'readonly':'');
																							}
											...
											<div class="medium-3 columns">
												<ul class="vertical tabs" data-tabs id="relation-tabs-1">
													<li class="tabs-title is-active"><a href="#panel1v-1" aria-selected="true">
														<input class="relationship relation_studied_cb" name="relationship_studied[]" id="relationship_studied-1" type="checkbox" value="studied_with_section"><label for="relationship_studied">Studied With</label>
													</a></li>
													<li class="tabs-title"><a href="#panel2v-1">
														<input class="relationship relation_danced_cb" name="relationship_danced[]" id="relationship_danced-1" type="checkbox" value="danced_for_section" ><label for="relationship_danced">Danced For</label>
													</a></li>
													<li class="tabs-title"><a href="#panel3v-1">
														<input class="relationship relation_collaborated_cb" name="relationship_collaborated[]" id="relationship_collaborated-1" type="checkbox" value="collaborated_with_section" ><label for="relationship_collaborated">Collaborated With</label>
													</a></li>
													<li class="tabs-title"><a href="#panel4v-1">
														<input class="relationship relation_influenced_cb" name="relationship_influenced[]" id="relationship_influenced-1" type="checkbox" value="influenced_by_section"><label for="relationship_influenced">Influenced By</label>
													</a></li>
												</ul>
											</div>
											<div class="medium-9 columns">
															...
															<div class="row duration_selection">
																...
																<div class="large-5 columns">
																	...
																	<div class="row">
																		<div class="medium-6 column">
																			<label>Start Date
																				<input type="text" class="start_date" id="influenced_start_date-1" placeholder="yyyy-mm-dd" name="influenced_start_date[]" >
																			</label>
																		</div>
																	</div>
																	<div class="row">
																		<div class="medium-6 column">
																			<label>End Date
																				<input type="text" class="end_date" id="influenced_end_date-1" placeholder="yyyy-mm-dd" name="influenced_end_date[]" >
																			</label>
																		</div>
																	</div>
																</div>
																<div class="large-5 columns">
																	...
																	<div class="row">
																		<div class="small-6 column">
																			<label for="duration_years">Years<small> Required</small>
																				<input  autocomplete="off" type="text" class="duration_years" id="influenced_duration_years-1" name="influenced_duration_years[]" placeholder="Years" >
																			</label>
																		</div>
																	</div>
																	<div class="row">
																		<div class="small-6 column">
																			<label for="duration_months">Months<small> Required</small>
																				<input  autocomplete="off" type="text" class="duration_months" id="influenced_duration_months-1" name="influenced_duration_months[]" placeholder="Months" >
																			</label>
																		</div>
																	</div>
																</div>
...
<script type="text/javascript">
	...
	function dateScripts(){
		...
		$(".relationship").click(function(){
			if(!$(this).is(":checked")){
				var relation_section = $(this).closest(".row").find("."+$(this).val());

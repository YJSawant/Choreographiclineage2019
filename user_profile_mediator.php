...
/*	include 'mail_template.php';
	...
	$message = "Hello $first_name $last_name,<br/>Welcome to Choreographic Lineage. You will need to set up your password in order to log onto the Lineage Contribution form. Please use the one time password mentioned below to login into your account and create your own password.<br/><br/>One Time Password: $user_one_time_password<br/><br/>Thanks,<br/>Choreographic Lineage Team";
